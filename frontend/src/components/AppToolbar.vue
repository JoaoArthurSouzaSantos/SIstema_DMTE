<template>
  <v-toolbar
    ...
    <v-toolbar-title class="ml-0 pl-3">
      ...
      <CadastroPerfil :dialogo_perfil="dialog"></CadastroPerfil>
  </v-toolbar>
</template>
<script>
import { vm } from "./../main";
import NotificationList from '@/components/widgets/list/NotificationList';
import CadastroPerfil from "@/views/form/CadastroPerfil.vue";
