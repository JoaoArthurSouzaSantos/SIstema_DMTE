export default [
  ...
  {
    path: '/forms/CadastroPermissao',
    meta: { breadcrumb: true },
    name: 'components/CadastroPermissao',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/CadastroPermissao.vue`
    )
  },
  {
    path: '/forms/CadastroPerfil',
    meta: { breadcrumb: true },
    name: 'components/CadastroPerfil',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/CadastroPerfil.vue`
    )
  },
  {
    path: '/forms/basic',
  ...
  {
    path: '/form/Usuario/formCadUsuario',
    meta: { breadcrumb: true },
    name: 'formCadUsuario',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Usuario/formCadUsuario.vue`
    )
  },
  // {
  //   path: '/teste',
  ...
  //     default: () => import(
  //       /* webpackChunkName: "routes" */
  //       `@/views/form/teste.vue`
  //     ),  

  //   }     
  // },  
  {
    path: '/form/Usuario/listUsuario',
    meta: { breadcrumb: true },
    name: 'listUsuario',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Usuario/listUsuario.vue`
    )
  },
  
  {
    path: '/form/Professor/FormCadProfessor',
    meta: { breadcrumb: true },
    name: 'CadastroProfessor',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Professor/CadastroProfessor.vue`
    )
  },
  {
    path: '/form/Professor/listarProfessor',
    meta: { breadcrumb: true },
    name: 'listProfessor',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Professor/listProfessor.vue`
    )
  },
  {
    path: '/form/Equipamentos/CadastroEquipamento',
    meta: { breadcrumb: true },
    name: 'CadastroEquipamento',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Equipamentos/CadastroEquipamento.vue`
    )
  },
  {
    path: '/form/Equipamentos/listarEquipamento',
    meta: { breadcrumb: true },
    name: 'listEquipamento',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Equipamentos/listEquipamento.vue`
    )
  },
  {
    path: '/form/Equipamentos/RelatorioEquipamento',
    meta: { breadcrumb: true },
    name: 'RelatorioEquipamento',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Equipamentos/RelatorioEquipamento.vue`
    )
  },
  {
    path: '/form/Equipamento/EmprestimoEquipamento',
    meta: { breadcrumb: true },
    name: 'EmprestimoEquipamento',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Equipamentos/EmprestimoEquipamento.vue`
    )
  },
  {
    path: '/form/Monografia/CadastroMonografia',
    meta: { breadcrumb: true },
    name: 'CadastroMonografia',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Monografias/CadastroMonografias.vue`
    )
  },
  {
    path: '/form/Monografia/listar',
    meta: { breadcrumb: true },
    name: 'listMonografia',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Monografias/listMonografias.vue`
    )
  },
  {
    path: '/form/Monografia/RelatorioMonografia',
    meta: { breadcrumb: true },
    name: 'RelatorioMonografia',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Monografias/RelatorioMonografias.vue`
    )
  },
  {
    path: '/form/Monografia/solicit_Monografia',
    meta: { breadcrumb: true },
    name: 'SolicitMonografia',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Monografias/SolicitMonografia.vue`
    )
  },
  {
    path: '/form/Evento/listarEvento',
    meta: { breadcrumb: true },
    name: 'listEventos',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Eventos/listEventos.vue`
    )
  },   
  {
    path: '/form/Evento/CadastroEventos',
    meta: { breadcrumb: true },
    name: 'CadastroEventos',
    component: () => import(
      /* webpackChunkName: "routes" */
      `@/views/form/Eventos/CadastroEventos.vue`
    )
  },
];
